...
public class MoaSkins {
    ...
    public static void registerMoaSkins() {
        ...
        register("brown_moa", new MoaSkin("brown_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasHumanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "textures/gui/perks/skins/icons/brown_moa_icon.png"))
        ...
        register("red_moa", new MoaSkin("red_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasHumanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "textures/gui/perks/skins/icons/red_moa_icon.png"))
        ...
        register("green_moa", new MoaSkin("green_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasHumanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "textures/gui/perks/skins/icons/green_moa_icon.png"))
        ...
        register("purple_moa", new MoaSkin("purple_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasHumanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "textures/gui/perks/skins/icons/purple_moa_icon.png"))
        ...
        register("pink_moa", new MoaSkin("pink_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasHumanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "skins/icons/pink_moa_icon"))
                .skinLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/skins/pink_moa/pink_moa.png"))
                .saddleLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/moa_saddle.png"))
                .info(new MoaSkin.Info(User.Tier.HUMAN, false))
        ));
        register("bronze_moa", new MoaSkin("bronze_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasHumanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "skins/icons/bronze_moa_icon"))
                .skinLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/skins/bronze_moa/bronze_moa.png"))
                .saddleLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/moa_saddle.png"))
                .info(new MoaSkin.Info(User.Tier.HUMAN, false))
        ));
        register("silver_moa", new MoaSkin("silver_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasHumanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "skins/icons/silver_moa_icon"))
                .skinLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/skins/silver_moa/silver_moa.png"))
                .saddleLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/moa_saddle.png"))
                .info(new MoaSkin.Info(User.Tier.HUMAN, false))
        ));
        register("gold_moa", new MoaSkin("gold_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasHumanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "skins/icons/gold_moa_icon"))
                .skinLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/skins/gold_moa/gold_moa.png"))
                .saddleLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/moa_saddle.png"))
                .info(new MoaSkin.Info(User.Tier.HUMAN, false))
        ));
        ...
        register("medical_bot", new MoaSkin("medical_bot", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasAscentanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "textures/gui/perks/skins/icons/medical_bot_icon.png"))
                .skinLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/skins/medical_bot/medical_bot.png"))
                .emissiveLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/skins/medical_bot/medical_bot_emissive.png"))
                .hatLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/skins/medical_bot/medical_bot_hat.png"))
                .saddleLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/skins/medical_bot/medical_bot_saddle.png"))
                .info(new MoaSkin.Info(User.Tier.ASCENTAN, false))
        ));
        register("skeleton_moa", new MoaSkin("skeleton_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasAscentanMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "textures/gui/perks/skins/icons/skeleton_moa_icon.png"))
                .skinLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/skins/skeleton_moa/skeleton_moa.png"))
                .saddleLocation(new ResourceLocation(Aether.MODID, "textures/entity/mobs/moa/skins/skeleton_moa/skeleton_moa_saddle.png"))
                .info(new MoaSkin.Info(User.Tier.ASCENTAN, false))
        ));
        ...
        register("peacock_moa", new MoaSkin("peacock_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasValkyrieMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "textures/gui/perks/skins/icons/peacock_moa_icon.png"))
        ...
        register("prehistoric_moa", new MoaSkin("prehistoric_moa", new MoaSkin.Properties()
                ...
                .userPredicate((user) -> PerkUtil.hasValkyrieMoaSkins().test(user))
                .iconLocation(new ResourceLocation(Aether.MODID, "textures/gui/perks/skins/icons/prehistoric_moa_icon.png"))
