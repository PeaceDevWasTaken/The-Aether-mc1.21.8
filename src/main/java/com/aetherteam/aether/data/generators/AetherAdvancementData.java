...
public class AetherAdvancementData extends FabricAdvancementProvider {
    public AetherAdvancementData(FabricDataOutput output) {
        super(output);
    }
    ...
    public void generateAdvancement(Consumer<Advancement> consumer) {
        Advancement theAether = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "the_aether").toString());
        ...
        Advancement enterAether = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "enter_aether").toString());
        ...
        Advancement readLore = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "read_lore").toString());
        ...
        Advancement loreception = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "loreception").toString());
        ...
        Advancement zanite = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "zanite").toString());
        ...
        Advancement craftAltar = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "craft_altar").toString());
        ...
        Advancement icestone = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "icestone").toString());
        ...
        Advancement iceAccessory = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "ice_accessory").toString());
        ...
        Advancement blueAercloud = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "blue_aercloud").toString());
        ...
        Advancement obtainEgg = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "obtain_egg").toString());
        ...
        Advancement incubateMoa = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "incubate_moa").toString());
        ...
        Advancement blackMoa = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "black_moa").toString());
        ...
        Advancement mountPhyg = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "mount_phyg").toString());
        ...
        Advancement enchantedGravitite = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "enchanted_gravitite").toString());
        ...
        Advancement gravititeArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "gravitite_armor").toString());
        ...
        Advancement bronzeDungeon = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "bronze_dungeon").toString());
        ...
        Advancement hammerLoot = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "hammer_loot").toString());
        ...
        Advancement zephyrHammer = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "zephyr_hammer").toString());
        ...
        Advancement lanceLoot = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "lance_loot").toString());
        ...
        Advancement silverDungeon = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "silver_dungeon").toString());
        ...
        Advancement valkyrieLoot = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "valkyrie_loot").toString());
        ...
        Advancement valkyrieHoe = Advancement.Builder.advancement()
                ...
                .display(AetherBlocks.AETHER_FARMLAND.get(),
                        ...
                        null,
                        FrameType.CHALLENGE, true, true, true)
                .addCriterion("valkyrie_hoe", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(Stream.concat(AbilityHooks.ToolHooks.TILLABLES.keySet().stream(), HoeItemAccessor.aether$getTillables().keySet().stream().sorted(Comparator.comparing(Block::getDescriptionId))).toList()).build()), ItemPredicate.Builder.item().of(AetherItems.VALKYRIE_HOE.get())))
                .save(consumer, new ResourceLocation(Aether.MODID, "valkyrie_hoe").toString());
        ...
        Advancement regenStone = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "regen_stone").toString());
        ...
        Advancement goldDungeon = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "gold_dungeon").toString());
        ...
        Advancement phoenixArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID, "phoenix_armor").toString());
        ...
        Advancement obsidianArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, new ResourceLocation(Aether.MODID,"obsidian_armor").toString());
