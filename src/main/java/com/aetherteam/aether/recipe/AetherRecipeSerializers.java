...
public class AetherRecipeSerializers {
	...
	public static final RegistryObject<RecipeSerializer<SwetBannerRecipe>> SWET_BANNER = RECIPE_SERIALIZERS.register("swet_banner", () -> new SimpleCraftingRecipeSerializer<>(SwetBannerRecipe::new));
}
