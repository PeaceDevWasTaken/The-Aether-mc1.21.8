...
public class AetherSoundEvents {
	public static final LazyRegistrar<SoundEvent> SOUNDS = LazyRegistrar.create(Registries.SOUND_EVENT, Aether.MODID);
	...
	public static final RegistryObject<SoundEvent> BLOCK_BLUE_AERCLOUD_BOUNCE = register("block.aercloud.blue_aercloud_bounce");
	...
	public static final RegistryObject<SoundEvent> ENTITY_SENTRY_SQUISH = register("entity.sentry.squish");
	public static final RegistryObject<SoundEvent> ENTITY_SENTRY_AMBIENT = register("entity.sentry.ambient");
	...
	public static final RegistryObject<SoundEvent> ENTITY_VALKYRIE_INTERACT = register("entity.valkyrie.interact");
	...
	public static final RegistryObject<SoundEvent> ENTITY_VALKYRIE_QUEEN_INTERACT = register("entity.valkyrie_queen.interact");
	...
	public static final RegistryObject<SoundEvent> ENTITY_FIRE_MINION_DEATH = register("entity.fire_minion.death");
	public static final RegistryObject<SoundEvent> ENTITY_FIRE_MINION_HURT = register("entity.fire_minion.hurt");

	public static final RegistryObject<SoundEvent> ENTITY_SUN_SPIRIT_INTERACT = register("entity.sun_spirit.interact");
	public static final RegistryObject<SoundEvent> ENTITY_SUN_SPIRIT_ACTIVATE = register("entity.sun_spirit.activate");
	public static final RegistryObject<SoundEvent> ENTITY_SUN_SPIRIT_SHOOT_FIRE = register("entity.sun_spirit.shoot_fire");
	public static final RegistryObject<SoundEvent> ENTITY_SUN_SPIRIT_SHOOT_ICE = register("entity.sun_spirit.shoot_ice");
	public static final RegistryObject<SoundEvent> ENTITY_SUN_SPIRIT_DEATH = register("entity.sun_spirit.death");
	public static final RegistryObject<SoundEvent> ENTITY_SUN_SPIRIT_HURT = register("entity.sun_spirit.hurt");
	...
	public static final RegistryObject<SoundEvent> UI_TOAST_AETHER_GOLD = register("ui.toast.aether_gold");
	...
	public static final RegistryObject<SoundEvent> MUSIC_BOSS_SLIDER = register("music.boss.slider");
	public static final RegistryObject<SoundEvent> MUSIC_BOSS_VALKYRIE_QUEEN = register("music.boss.valkyrie_queen");
	public static final RegistryObject<SoundEvent> MUSIC_BOSS_SUN_SPIRIT = register("music.boss.sun_spirit");
