...
public class AetherRenderers {
    ...
    public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(AetherEntityTypes.SKYROOT_BOAT.get(), (context) -> new SkyrootBoatRenderer(context, ModelLayers.OAK_BOAT, SkyrootBoatRenderer.SKYROOT_BOAT));
        event.registerEntityRenderer(AetherEntityTypes.SKYROOT_CHEST_BOAT.get(), (context) -> new SkyrootBoatRenderer(context, ModelLayers.OAK_CHEST_BOAT, SkyrootBoatRenderer.SKYROOT_CHEST_BOAT));
    ...
    public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(AetherModelLayers.PHYG_BABY, () -> PigModel.createBodyLayer(CubeDeformation.NONE).apply(PigModel.BABY_TRANSFORMER));
        event.registerLayerDefinition(AetherModelLayers.PHYG_BABY_SADDLE, () -> PigModel.createBodyLayer(new CubeDeformation(0.5F)).apply(PigModel.BABY_TRANSFORMER));
        ...
        event.registerLayerDefinition(AetherModelLayers.SHEEPUFF_BABY_WOOL, () -> SheepuffWoolModel.createFurLayer(new CubeDeformation(1.75F), 0.0F).apply(SheepModel.BABY_TRANSFORMER));
        event.registerLayerDefinition(AetherModelLayers.SHEEPUFF_BABY_WOOL_PUFFED, () -> SheepuffWoolModel.createFurLayer(new CubeDeformation(3.75F), 2.0F).apply(SheepModel.BABY_TRANSFORMER));
